class Game < ActiveRecord::Base
  ...
  private 
    ...
    def update_stats
      ...
      game.team1.stats.update(wins: game.team1.stats.wins + 1, current_streak: game.team1.stats.current_streak)
      game.team2.stats.update(losses: game.team2.stats.losses + 1, current_streak: game.team2.stats.current_streak)
    end
end
